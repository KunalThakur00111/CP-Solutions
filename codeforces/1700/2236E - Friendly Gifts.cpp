...
void solve(){
    ...
    // i am thinking is keep what i to j is min and max, no duplicate for every pair,
    vector<vector<bool>> auraa(n+1,vector<bool>(n+2,false));
    vector<int> mp(n+1);
    for(int i=0;i<n;i++){
